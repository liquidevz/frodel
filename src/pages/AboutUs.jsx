...
const AboutUs = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-12 bg-gradient-to-br from-blue-600 to-cyan-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl font-bold mb-4">About Frodel Enterprises</h1>
          <p className="text-xl opacity-90">Quality Frozen Foods Since 2014</p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">Where We Started</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">Where We Are Going</h2>
          <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">Beyond The Business Lines</h2>
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Social Enterprise Initiatives</h3>
          <ul className="space-y-2 text-gray-700 text-lg leading-relaxed list-disc list-inside">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">Why You Should Try Our Products</h2>
          <ul className="grid md:grid-cols-2 gap-3 text-gray-700 text-lg list-disc list-inside">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-12">
            <div>
              ...
              <p className="text-lg leading-relaxed opacity-90">To carve an identity as the Best & Biggest Food Product Manufacturer & provide opportunity to all those eligible to associate & earn a decent livelihood in or with our organisation.</p>
            </div>
            <div>
              <h2 className="text-3xl font-bold mb-4">Our Mission</h2>
              <p className="text-lg leading-relaxed opacity-90">To provide authentic, safe & hygienic food products for best price & diversify ourselves in various fields giving honest & genuine products & services. And thus contributing towards - Making this world a better place to live.</p>
            </div>
            <div>
